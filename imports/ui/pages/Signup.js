    ...
    return (
      ...
      <div className="page-wrapper">
        ...
        <Helmet
          title="Sign up"
          meta={[
              {"name": "description", "content": "Regístrate y recibe las mejores frutas y verduras hasta la puerta de tu casa."}
          ]}
        />
          ...
          <div className="background-video w-background-video" data-autoplay="data-autoplay" data-loop="data-loop" data-poster-url="https://daks2k3a4ib2z.cloudfront.net/58cb198e4d198bcc429dae6e/58e539708991d7054c3c6f95_central fresh-poster-00001.jpg" data-video-urls="https://daks2k3a4ib2z.cloudfront.net/58cb198e4d198bcc429dae6e/58e539708991d7054c3c6f95_central fresh-transcode.webm,https://daks2k3a4ib2z.cloudfront.net/58cb198e4d198bcc429dae6e/58e539708991d7054c3c6f95_central fresh-transcode.mp4" data-wf-ignore="data-wf-ignore">
            ...
            <div className="contentblock">
              ...
              <div className="div-block-4 w-clearfix">
                <h3 className="heading-10">Regístrate</h3><a className="loginfb w-button" href="#" onClick={this._loginFacebook.bind(this)}>Ingresa con facebook</a>
                <div className="div-block-5"></div>
                <div className="div-block-5 left"></div>
                {/* <div className="text-block-4">o</div> */}
                <div className="w-form">
                  <form data-name="Email Form" id="email-form" name="email-form" onSubmit={this._handleSignup.bind(this)}>
                    <input className="formfield w-input" ref="name" placeholder="Nombre(s)" required="required" type="text" />
                    <input className="formfield w-input" ref="last_name" placeholder="Apellidos(s)" required="required" type="text" />
                    <input className="formfield w-input" ref="email" placeholder="Email" required="required" type="email" />
                    <input className="formfield w-input" ref="password" placeholder="Contraseña" required="required" type="password" />
                    <input className="loginbutton w-button" data-wait="Please wait..." type="submit" value={!this.state.logginIn ? 'Regístrate' : 'Procesando...'} disabled={this.state.logginIn} />
                  </form>
                </div>
                <div className="logintext">¿Ya estás registrado? <Link to="/login" className="logintextlink">Inicia sesión</Link>
                </div>
              </div>
            </div>
          </div>
